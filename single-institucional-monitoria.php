                    ...
                    <div class="container">
                        <?php foreach ($setores as $setor): ?>
                            <h2 class="text-center text-xl font-semibold mt-8 titulo-setor">
                                <?php echo esc_html($setor['nome_do_setor']); ?></h2>
                    ...
                    <div class="container">
                        ...
                        <div class="text-center">
                            ...
                            ?>
                                        ...
                                        <?php if ($count_items % 3 == 0)
                                            echo '<div style="width: 100%;"></div>'; // Quebra a linha a cada 3 itens 
                                        ?>
                                    <?php
                                    endif;
                                endforeach;
                ...
                <div class="container">
                    ...
                    <div class="accordion">
                        ...
                        <div class="accordion-item">
                            ...
                            <div class="accordion-content">
                                <p>O candidato precisa ter participado do ENEM a partir de 2010, obtendo pelo menos 450 pontos
                                    na média das provas e nota acima de zero na redação.</p>
                                <p>As inscrições são feitas através do <a href="https://acessounico.mec.gov.br/fies"
                                        target="_blank">Portal Único de Acesso ao Ensino Superior</a>.</p>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            ...
                            <div class="accordion-content">
                                <p>O Programa Universidade Para Todos (Prouni) oferece bolsas integrais e parciais para
                                    estudantes sem diploma de nível superior em instituições privadas de ensino superior.</p>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            ...
                            <div class="accordion-content">
                                <p>As inscrições devem ser feitas através do <a href="https://acessounico.mec.gov.br/prouni"
                                        target="_blank">Portal Único de Acesso ao Ensino Superior</a>.</p>
                            </div>
                        </div>
                    </div>
