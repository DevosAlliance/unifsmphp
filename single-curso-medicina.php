...
?>
    ...
    <main class="main">
      <section class="section">
        <div class="title__box">
          ...
          <div class="courses__btns">
            <button class="cs__btn" onclick="window.open('<?php echo esc_html($edital); ?>', '_blank')">Edital</button>
      ...
      <section class="section">
        <div class="container course__container__med">
          <div class="advisors">
           ...
           <div class="faculty">
            ...
            <div class="faculty__grid">
                <?php if (have_rows('estrutura_academica_copiar')) : ?>
                    ...
                    ?>
                    <div class="faculty__card white--color">
                        <div class="fc__content--white">
                            <div class="fc__infos">
                            ...
                            <div class="fc__link">
                                <?php if ($lattes) : ?>
                                    <a class="white--color" href="<?php echo esc_url($lattes); ?>" target="_blank">
